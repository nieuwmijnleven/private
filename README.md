...
Making your existing Java code null-safe with JADEx is simple and straightforward. The following process guides you from analyzing potential null-pointer issues to applying null-safety operators, and finally generating safe, standard Java code—all without rewriting your code or leaving the Java ecosystem.
